...
function Healthpolicy() {
    return (
      ...
      <div className="projects-content">
        ...
        <h2>All the essentials, simplified.</h2>
        <p>
          Understand the key elements of your insurance plan, including coverage limits, 
          payment options, and extra benefits—so you can make confident, informed choices.
        </p>
        <button className="view-button">View All Projects</button>
      </div>
      ...
      <div className="projects-grid">
        ...
        <Flipcard
          imageSrc={img3}
          title="⚖️ Co-Pay & Deductible Terms"
