    ...
    return (
        <section className="Policyfeature-section">
            <div className="service-header">
                ...
                <p>
                    Every life insurance policy has key features that protect 
                    you and your family. Coverage amount and policy term help 
                    secure your loved ones’ future and fit your
                </p>
